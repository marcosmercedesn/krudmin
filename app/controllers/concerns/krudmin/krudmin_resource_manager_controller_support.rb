module Krudmin
  module KrudminResourceManagerControllerSupport
    ...
    included do
      delegate :permitted_attributes, :resource_label, :resources_label, :scope, :listable_actions, :listable_attributes, :readonly_attributes, :model_class, :editable_attributes, :lookup_attributes, to: :krudmin_manager
      ...
      helper_method :resource_label, :resources_label, :items, :model_label, :resource_root, :listable_actions, :listable_attributes, :readonly_attributes, :model_class, :model, :editable_attributes
    ...
    def model_params
      @model_params ||= Krudmin::ParamsParser.new(permitted_params, krudmin_manager).to_h.permit!
    end
